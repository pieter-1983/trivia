...
public class GameRunnerTest {
    @Test
    public void runWithSeed() throws Exception {
        //setup outputstream to capture console logs
        ByteArrayOutputStream outContent = new ByteArrayOutputStream();
        System.setOut(new PrintStream(outContent));
        //run the game with a seed
        GameRunner gameRunner= new GameRunner();
        gameRunner.run(new Random(1));
        //result should be equal to this
        ...
        assertThat(outContent.toString(),is(equalTo(result)));
    }
